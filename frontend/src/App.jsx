  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50  via-indigo-50/40 to-purple-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Toast Notification */}
        {toast && (
          <div className={`fixed top-4 right-4 z-50 rounded-2xl border-2 px-6 py-4 text-sm font-semibold shadow-2xl backdrop-blur-sm animate-fade-in ${
            toast.type === 'warning' 
                        ...
                        <div className="flex items-center gap-6 flex-wrap">
                          <div>
                            ...
                            <p className={`text-3xl font-extrabold ${
                              scannedItem.quantity < 5 ? 'bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent' : 
